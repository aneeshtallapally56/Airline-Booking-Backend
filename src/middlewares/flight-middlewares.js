...
function validateUpdateSeatsRequest(req, res, next) {
  ...
  if (!req.params.id) {
    errors.push("Flight ID is missing in the URL");
  }

  if (req.body.seats == null || isNaN(req.body.seats)) {
    errors.push("seats not found or is not a valid number");
  }
  if (errors.length) {
    ErrorResponse.message = "Invalid data for updating flight seats";
